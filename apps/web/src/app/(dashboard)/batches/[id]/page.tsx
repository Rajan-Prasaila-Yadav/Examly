                      ...
                      <td className="py-3 px-3">
                        <div className="flex items-center gap-1.5">
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-lg text-[11px] font-bold border bg-brand-50 hover:bg-brand-100 text-brand-700 border-brand-200/80 transition-colors cursor-pointer"
                          >
                            <GraduationCap className="w-3 h-3" />
                            <span className="truncate max-w-[130px]">{batch.name}</span>
